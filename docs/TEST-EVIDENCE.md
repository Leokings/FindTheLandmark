...
- Build, lint, contract lint, 16 direct contract tests, the StudioNet deployment policy test, and 25 app tests pass. A 30-active-player StudioNet match and 12/12 round settlement are verified, but 30/30 scoring in every round is **not**.
